    ...
    return (
      <div className="driver-order-card" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
        ...
        <div className="order-content">
          <div className="customer-reveal" onClick={()=> setExpanded(v=>!v)}>
            {expanded ? (
              <div className="customer-line" title="Tap to collapse">
                ...
                <span className="inline-icons" onClick={(e)=> e.stopPropagation()}>
              ...
              <div className="swipe-hint" title="Swipe down for customer info">Swipe down to view customer info</div>
            )}
          </div>
