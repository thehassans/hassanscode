      ...
      <div className="driver-order-card" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
        ...
        <div className="order-content">
              ...
              <div className="order-details">
                ...
                {(order.locationLat && order.locationLng) && (
                  <div className="info-row">
                    ...
                    <span className="value">{Number(order.locationLat).toFixed(6)}, {Number(order.locationLng).toFixed(6)}</span>
                  </div>
                )}
                <div className="info-row">
          ...
          <div className="action-bar" style={{display:'flex', gap:10, justifyContent:'space-between', marginTop:10}}>
            ...
            <button className="inline-icon-btn sms" onClick={()=> openSMS(order.customerPhone)} title="SMS" aria-label="SMS">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden><path d="M20 2H4c-1.1 0-2 .9-2 2v14l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>
            </button>
