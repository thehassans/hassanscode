    ...
    <div className="content" style={{display:'grid', gap:16, padding:16, maxWidth: 900, margin:'0 auto'}}>
      ...
      <div className="panel" style={{display:'grid', gap:16}}>
        <div style={{display:'flex', alignItems:'center', gap:8}}>
          <span aria-hidden style={{color:'var(--muted)'}}><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg></span>
        ...
        <div style={{display:'grid', gap:12}}>
          ...
          <div style={{display:'grid', gap:8, padding:12, background:'var(--panel-2)', borderRadius:8}}>
            <div style={{display:'flex', alignItems:'center', gap:8}}>
        ...
        <div style={{display:'grid', gap:16}}>
          ...
          <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 0', borderBottom:'1px solid var(--border)'}}>
            <div style={{display:'flex', alignItems:'center', gap:12}}>
              ...
              <div>
                ...
                <div style={{fontSize:12, color:'var(--muted)'}}>{soundEnabled ? ringtone.charAt(0).toUpperCase() + ringtone.slice(1) : 'Disabled'}</div>
              </div>
            </div>
            <div style={{display:'flex', gap:6, alignItems:'center'}}>
              <select className="input small" value={ringtone} onChange={e=>{ const k=e.target.value; setRingtone(k); storeSoundPrefs(soundEnabled, k) }} style={{minWidth:100}}>
              ...
              <button type="button" className="btn small secondary" onClick={playPreview}>Test</button>
            </div>
          </div>
          ...
          <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', padding:'12px 0'}}>
            ...
            <button 
              ...
              onClick={()=>{ setShowPassModal(true); setCurrentPassword(''); setNewPassword(''); setConfirmPassword('') }}
            >
              Change Password
            </button>
          </div>
      ...
      <div className="card" style={{padding:20}}>
        <div style={{display:'flex', alignItems:'center', gap:12, marginBottom:20}}>
          ...
          <div>
            ...
            <div style={{fontSize:12, color:'var(--muted)'}}>Track your performance and unlock rewards</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          borderRadius:12, padding:16, marginBottom:20, color:'white'
        }}>
          ...
          <div style={{marginBottom:8}}>
            <div style={{position:'relative', height:8, borderRadius:999, background:'rgba(255,255,255,0.2)', overflow:'hidden'}}>
              <div style={{
          ...
          <div style={{fontSize:12, opacity:0.9}}>
            {levelInfo.next ? (
              <span>Next: {levelInfo.next.title} at {levelInfo.next.count} orders ({levelInfo.next.count - levelInfo.submitted} more to go)</span>
            ) : (
        ...
        {/* Achievement Badges */}
        <div>
          <div style={{fontWeight:600, marginBottom:12, color:'var(--fg)'}}>Achievement Badges</div>
          <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(160px, 1fr))', gap:12}}>
            {levels.map((lv, i)=>{
              const unlocked = (perf.ordersSubmitted||0) >= lv.count
              return (
                <div key={lv.count} style={{
                  ...
                  <div style={{fontSize:12, color:'var(--muted)', marginBottom:8}}>≥ {lv.count} orders</div>
                  {unlocked ? (
                    <div style={{
